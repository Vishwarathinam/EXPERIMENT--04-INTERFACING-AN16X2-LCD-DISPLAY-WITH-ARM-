...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  Lcd_cursor(&lcd, 0,1);
	  Lcd_string(&lcd, "Vishwa Rathinam S\n");


	  for(int x=0;x<100;x++)
	  {
		  Lcd_cursor(&lcd, 1,0);
		  Lcd_string(&lcd, "212221240063");
		  HAL_Delay (200);
...
## Output screen shots of proteus  :
 ...
 ![Screenshot 2023-10-10 083515](https://github.com/Vishwarathinam/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/95266350/451ee6e5-9ecc-4b9a-bfc8-caad7467eb68)
